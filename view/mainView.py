...
class MainView(object):
    def setupUi(self, MainWindow, presenter):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_generate_classes.sizePolicy().hasHeightForWidth())
        self.label_generate_classes.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_generate_classes.setFont(font)
        self.label_generate_classes.setObjectName("label_generate_classes")
        self.verticalLayout_2.addWidget(self.label_generate_classes)
        self.generate_classes = QtWidgets.QPushButton(self.centralwidget)
        self.generate_classes.setObjectName("generate_classes")
        self.verticalLayout_2.addWidget(self.generate_classes)
        ...
        self.statistics_menu = QtWidgets.QMenu(self.menubar)
        self.statistics_menu.setObjectName("statistics_menu")
        ...
        self.annotation_statistics_action = QtWidgets.QAction(MainWindow)
        self.annotation_statistics_action.setObjectName("annotation_statistics_action")
        ...
        self.annotation_statistics_action = QtWidgets.QAction(MainWindow)
        self.annotation_statistics_action.setObjectName("annotation_statistics_action")
        self.class_action = QtWidgets.QAction(MainWindow)
        self.class_action.setObjectName("class_action")
        self.img_action = QtWidgets.QAction(MainWindow)
        self.img_action.setObjectName("img_action")
        self.exif_action = QtWidgets.QAction(MainWindow)
        self.exif_action.setObjectName("exif_action")
        ...
        self.statistics_menu.addAction(self.annotation_statistics_action)
        self.statistics_menu.addAction(self.class_action)
        self.statistics_menu.addAction(self.img_action)
        self.statistics_menu.addAction(self.exif_action)
        self.menubar.addAction(self.file_menu.menuAction())
        self.menubar.addAction(self.export_menu.menuAction())
        self.menubar.addAction(self.import_menu.menuAction())
        self.menubar.addAction(self.statistics_menu.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_generate_classes.setText(_translate("MainWindow", "Generowanie klas:"))
        self.generate_classes.setText(_translate("MainWindow", "Wygeneruj klasy automatycznie"))
        ...
        self.statistics_menu.setTitle(_translate("MainWindow", "Statystyki"))
        ...
        self.annotation_statistics_action.setText(_translate("MainWindow", "Adnotacje"))
        ...
        self.class_action.setText(_translate("MainWindow", "Klasy"))
        self.img_action.setText(_translate("MainWindow", "Obrazy"))
        self.exif_action.setText(_translate("MainWindow", "Metadane(EXIF)"))
